...
class DealingListController: BaseViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    deinit {
        ...
        print("DealingListController 释放")
    }
    ...
    override func viewDidLoad() {
        ...
        tableView?.addRefreshHeader({ (header) -> Void in
            ...
            if weakSelf!.tableView!.mj_footer.isRefreshing() {
                ...
                weakSelf!.tableView!.mj_header.endRefreshing()
                 ...
                 weakSelf!.tableView!.mj_footer.setExtensionStatus(MJExtensionStatus_Idle)
        ...
        tableView?.addRefreshFooter({ (footer) -> Void in
            ...
            if weakSelf!.tableView!.mj_header.isRefreshing() || weakSelf!.tableView!.mj_footer.extensionStatus() == MJExtensionStatus_NoMoreData {
    ...
    func refreshData() {
        weak var weakSelf = self
        self.getDealingMoneyList("0", success: { (list:[CashHistoryModel]?, count: Int32) -> Void in
        ...
        }, failed: {(msg: String?) -> Void in
                weakSelf!.tableView?.mj_header.endRefreshing()
                weakSelf!.showHint(msg ?? "请求失败")
        })
    }
    ...
    func loadMoreData(){
        ...
        weak var weakSelf = self
        self.getDealingMoneyList((model! as AnyObject).order_id, success: { (list:[CashHistoryModel]?,count: Int32) -> Void in
